...
namespace Utilities
{
    ...
    {
        String SqlConnectString = "server=cis-mssql1.temple.edu;Database=sp17_3342_tue95606;User id=tue95606;Password=ohzii2Ae";
        //string SqlConnectString = "server=127.0.0.1,5555;Database=SP17_3342_tue95606;User id=tue95606;Password=ohzii2Ae";
        static SqlConnection myConnectionSql;
        SqlCommand objCmd;
        ...
        public static Object ExecuteScalarFunction(SqlCommand theCommand)
        {
            theCommand.Connection = myConnectionSql;
